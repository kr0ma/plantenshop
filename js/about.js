...
//CHAINING
    //  OORSPRONKELIJKE UL VERSIE
    /*
     //$('<ul>').insertAfter('#team');
     //$('#team').after('<ul>').append('<li>eerste item</li>').append('<li>tweede item</li>');
     //$('#team h3').after($('<ul>').append('<li>eerste item</li>').append('<li>tweede item</li>'));
     var $uul = $('<ul>');
...
// enkel als elementNode, in de lijst sectionElms en geen no-toc
    ...
    return (node.nodeType === 1 &&
            arrSections.indexOf(node.tagName.toLowerCase()) >= 0 &&
