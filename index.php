...
if (isset($_GET['page'])) {
    ...
    switch ($page) {
        ...
        case "shop":
            ...
            $tpl['paginaScripts'] = getScriptElements(array("js/vendor/jquery/Datatables-1.10.10/media/js/jquery.dataTables.min.js","js/shop.js"));
        ...
        case "ajaxshop":
            ...
            $tpl['paginaScripts'] = getScriptElements(array(
                "js/vendor/jquery/Datatables-1.10.10/media/js/jquery.dataTables.min.js",
                "js/vendor/jquery/Datatables-1.10.10/media/js/dataTables.fnReloadAjax.js",
                "js/ajaxshop.js"));
            $tpl['paginaStylesheets'] = getLinkElements("js/vendor/jquery/Datatables-1.10.10/media/css/jquery.dataTables.css");
            break;
        ...
        case "galerij":
            ...
            $tpl['paginaScripts'] = getScriptElements(array("js/vendor/jquery/lightbox/js/lightbox.js", "js/vendor/jquery/jquery.ui.knipoog.js","js/galerij.js"));
