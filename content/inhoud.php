...
function getRegistreer() {
    ...
    $str .= "<fieldset>
					  ...
					  <div>
						<label for='ww1'>wachtwoord<abbr class='verplicht' title='verplicht'>*</abbr>:
                                                <!--start dialogbutton-->
                                                <br><a href='#' id='dialog_link_ww1'>Meer uitleg</a>
                                                <!--einde dialogbutton -->
                                                </label>
...
function getWw1Dialog() {
    $str = "<!-- ui-dialog -->
                <div id='dialog_ww1' class='dialoogvenster' title='Uw gebruikersnaam'>
    		<p>Paswoord blablabla jo.</p>
    		</div>
  			<!-- ui-dialog -->";
